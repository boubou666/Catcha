...
| Oak items              | Technology tree (Tech Points)                | weapons = click damage, structures = unlocks |
...
- Hatched Pals inherit up to 4 passive skills from a small pool (`+10% attack`, `+work speed`…).
