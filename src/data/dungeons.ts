...
export const DUNGEONS: DungeonDef[] = [
  ...
  { id: 'swordmaster', regionId: 'dunes', name: 'Sealed Realm of the Swordmaster', level: 36, waves: 5, timeLimitSec: 300,
    ...
    loot: { gold: 6000, items: [d('paldium', 1, 30, 60), d('ingot', 1, 4, 8), d('sphere_hyper', 0.5, 1, 2), d('high_quality_pal_oil', 0.7, 2, 4), d('diamond', 0.05, 1, 1)] },
  ...
  { id: 'winged_tyrant', regionId: 'obsidian', name: 'Sealed Realm of the Winged Tyrant', level: 46, waves: 5, timeLimitSec: 300,
    ...
    loot: { gold: 20000, items: [d('paldium', 1, 50, 90), d('ingot', 1, 6, 12), d('sphere_hyper', 0.7, 1, 3), d('high_quality_pal_oil', 1, 3, 6), d('diamond', 0.1, 1, 1)] },
  ...
  { id: 'pristine', regionId: 'astral', name: 'Sealed Realm of the Pristine', level: 56, waves: 5, timeLimitSec: 300,
    ...
    loot: { gold: 60000, items: [d('paldium', 1, 80, 140), d('ingot', 1, 10, 18), d('sphere_ultra', 0.6, 1, 3), d('high_quality_pal_oil', 1, 4, 8), d('diamond', 0.2, 1, 1)] },
  ...
  { id: 'moonlit', regionId: 'sakurajima', name: 'Sealed Realm of the Moonlit', level: 63, waves: 5, timeLimitSec: 300,
    ...
    loot: { gold: 150000, items: [d('paldium', 1, 120, 200), d('ingot', 1, 15, 25), d('sphere_ultra', 0.8, 2, 4), d('high_quality_pal_oil', 1, 6, 10), d('diamond', 0.3, 1, 2)] },
  ...
  { id: 'starfall_realm', regionId: 'feybreak', name: 'Sealed Realm of the Starfall', level: 71, waves: 5, timeLimitSec: 300,
    ...
    loot: { gold: 400000, items: [d('paldium', 1, 200, 300), d('ingot', 1, 25, 40), d('sphere_legendary', 0.5, 1, 2), d('high_quality_pal_oil', 1, 10, 15), d('diamond', 0.5, 1, 3)] },
