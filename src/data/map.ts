...
export const REGION_MAPS: RegionMapDef[] = [
  { regionId: 'windswept', box: [990, 430, 560, 760], label: [1270, 1170], spots: {
    ...
    base: [1105, 1055], altar: [1300, 1080],
  } },
  { regionId: 'marsh', box: [860, 560, 400, 360], label: [1000, 905], spots: {
    ...
    grintale: [1030, 668], elizabee: [1150, 785], kingpaca: [1085, 745], lily: [1150, 700], invincible: [1060, 690],
  } },
  { regionId: 'dunes', box: [1350, 180, 420, 470], label: [1560, 620], spots: {
    ...
    elphidran: [1450, 470], mammorest: [1610, 360], anubis: [1540, 590], axel: [1580, 240], swordmaster: [1700, 520],
  } },
  ...
  { regionId: 'astral', box: [960, 200, 420, 400], label: [1150, 250], spots: {
    ...
    wumpo: [1030, 470], cryolinx: [1040, 330], frostallion: [1180, 340], victor: [1170, 265], pristine: [1265, 500],
  } },
  { regionId: 'sakurajima', box: [720, 400, 330, 260], label: [880, 395], spots: {
    ...
    knocklem: [920, 500], dogen: [860, 600], xenolord: [940, 590], saya: [860, 450], moonlit: [960, 585],
  } },
  { regionId: 'feybreak', box: [300, 1170, 600, 660], label: [560, 1250], spots: {
    ...
    omascul: [560, 1360], azurmane: [660, 1440], bellanoir: [520, 1700], bjorn: [760, 1300], starfall_realm: [470, 1560],
  } },
];
