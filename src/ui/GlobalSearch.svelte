...
<style>
  ...
  .results { position: absolute; top: calc(100% + 0.3rem); left: 0; right: 0; z-index: 30; max-height: 60vh; overflow-y: auto; padding: 0.3rem; display: flex; flex-direction: column; gap: 0.15rem; box-shadow: 0 10px 30px rgba(0, 0, 0, 0.5); }
