...
export function newStats(): SaveState['stats'] {
  return {
    ...
    goldEarned: 0, goldSpent: 0, playSeconds: 0, throws: 0, condensed: 0, luckyDefeated: 0, chanceSum: 0, ratedThrows: 0, baseRaidsRepelled: 0, baseRaidsLost: 0, challengesDone: 0, rematchesWon: 0,
